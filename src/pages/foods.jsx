...
const [order,setOrder] = useState('');
 const [arraySorted,setarraySorted] = useState(products);
  ...
  const displayPage = filteredItems.slice(pageVisted, productsPerPage + pageVisted) 
  ...
  return (
      ...
      >
     <CommonSection title='All Pastries... '></CommonSection>
      ...
      <div className='my-2 md:flex justify-between p-5 sm:p-10 lg:px-28 w-full' >
        ...
        <div className=' w-full md:w-auto'>
          <select onChange={(e)=>setOrder(e.target.value)} placeholder='default' className='p-2 promo rounded-md placeholder:text-black placeholder:text-xs text-xs w-full md:w-auto my-2 sm:my-0' >
          <option value="Default">Default</option>
            <option value='asc'>Higest To Lowest</option>
            <option value='dsc'>Lowest to Highest</option>
    ...
    return (
       <div className='flex items-center justify-center' key={products.id}>
