    ...
    <div className='w-full bg-slate-500 flex flex-col items-center text-sm relative bottom-0' >
      ...
      <div className='flex flex-col gap-y-4 md:items-center'>
        <div className='flex justify-start items-center'>
         ...
         <span className='text-xl font-semibold text-white tracking-wider '><span className=' font-serif'>W</span><span className='font-serif'>r</span ><span className=' font-serif'>l</span><span className= 'font-serif'>d</span></span>
   ...
   {/* CONTACT LOCATION SECTION */}
      <div className='flex flex-col'>
       ...
       <div className='flex flex-col gap-y-3'>
          ...
          <p> Put in your business address here </p>
          {/* //location */}
          </div>
     ...
     {/* info section */}
      ...
      <span className='text-white text-[12px] flex justify-center py-2 text-center'> &copy; 2023 Made with 💖 by EmpireFx Technologies. All right Reserved </span>
