 ...
 const LogOut = async (e) => {
  ...
  return (
    ...
    className="hidden md:flex lg:ml-6 pl-5 px-10 p-3 justify-between">
     ...
     <span className='text-black font-serif'>r</span >
    <span className='text-black font-serif'>l</span>
    <span className=' font-serif'>d</span></span>
      </motion.div>
    ...
    <Link to="/">
      ...
      transition={{ type:'spring', duration: 0.2 , stiffness:150 }}
       className='flex justify-start items-center font-semibold'><img src={logo} alt="Logo"  className='w-11 h-11'/> <span className='text-2xl tracking-wide '><span className=' font-serif'>W</span><span className='font-serif'>r</span ><span className=' font-serif'>l</span><span className= 'font-serif'>d</span></span></motion.div>
      </Link>
